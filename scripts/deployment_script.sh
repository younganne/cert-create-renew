...
# Certificate paths
CERT_DIR="/etc/letsencrypt/live/malkovich.sys.icsi.berkeley.edu"
COHESITY_HOST="malkovich.sys.icsi.berkeley.edu"
COHESITY_USER="support"
SSH_KEY="/home/ubuntu/.ssh/id_ed25519_gh"
...
scp -i $SSH_KEY /tmp/privkey.pem /tmp/cohesity_cert.pem $COHESITY_USER@$COHESITY_HOST:/home/support/certs/
chmod 600 /home/support/certs/cohesity_cert.pem
chmod 400 /home/support/certs/privkey.pem

# Install certificate via SSH command
iris_cli
